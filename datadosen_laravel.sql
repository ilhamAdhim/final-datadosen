...
('RTI184001', 'RPS_RTI184001_SistemInformasi', NULL),
...
INSERT INTO `users` (`id`, `code`, `password`, `email`, `phone`, `photo`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
(4, 'VS', 'vipcash', '', '', '', '2020-05-27 11:31:47', NULL, '2020-05-27 11:31:47', '2020-05-27 11:31:47'),
(5, 'ADE', 'ADE', '', '', '', '2020-05-27 11:31:47', NULL, '2020-05-27 11:31:47', '2020-05-27 11:31:47'),
(6, 'WID', 'widaa', '', '', '', '2020-05-27 11:31:47', NULL, '2020-05-27 11:31:47', '2020-05-27 11:31:47'),
(7, 'ZUL', 'zuk', '', '', '', '2020-05-27 11:31:47', NULL, '2020-05-27 11:31:47', '2020-05-27 11:31:47'),
(15, 'IFR', '$2y$10$XvEmRdZLHz2kUaoVKDK6beaPNOp4YvafGctv/IeFNTr1R9EyadVY6', 'imam@gmail.com', NULL, NULL, '2020-05-29 14:36:18', NULL, '2020-05-29 07:36:18', '2020-05-29 07:36:18'),
(17, 'ATQ', '$2y$10$5dvUGUkyetCsTNg8kH3JL.HRAP/EtpmGdGq61ltG0Gt4.G4CWOucW', 'buatiqah@gmail.com', NULL, NULL, '2020-05-29 16:29:39', NULL, '2020-05-29 09:29:39', '2020-05-29 09:30:15');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vu_class_schedule`  AS  select `datadosen`.`tb_lecturer`.`code` AS `code`,`datadosen`.`tb_lecturer`.`name` AS `name`,`datadosen`.`tb_subjects`.`subject` AS `subject`,`datadosen`.`tb_subjects`.`subject_code` AS `subject_code`,concat(`datadosen`.`tb_class`.`cl_major`,'-',`datadosen`.`tb_class`.`cl_level`,`datadosen`.`tb_class`.`cl_name`) AS `class`,sum(`datadosen`.`tb_class_schedule`.`hour`) AS `total_hour`,`datadosen`.`tb_class_schedule`.`semester` AS `semester`,`datadosen`.`tb_class_schedule`.`year` AS `year` from (((`datadosen`.`tb_lecturer` join `datadosen`.`tb_class_schedule` on((`datadosen`.`tb_lecturer`.`code` = `datadosen`.`tb_class_schedule`.`lc_code`))) join `datadosen`.`tb_class` on((`datadosen`.`tb_class`.`cl_id` = `datadosen`.`tb_class_schedule`.`cl_id`))) join `datadosen`.`tb_subjects` on((`datadosen`.`tb_subjects`.`subject_code` = `datadosen`.`tb_class_schedule`.`subject_code`))) group by `datadosen`.`tb_lecturer`.`name`,`datadosen`.`tb_class_schedule`.`semester` ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vu_contracts_lecturer`  AS  select `vu_class_schedule`.`code` AS `code`,`vu_class_schedule`.`name` AS `name`,`vu_class_schedule`.`subject` AS `subject`,`vu_class_schedule`.`subject_code` AS `subject_code`,`datadosen`.`tb_contract_files`.`contract_file` AS `contract_file` from (`datadosen`.`vu_class_schedule` join `datadosen`.`tb_contract_files` on((`vu_class_schedule`.`subject_code` = `datadosen`.`tb_contract_files`.`subject_code`))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vu_dpa`  AS  select `datadosen`.`tb_lecturer`.`code` AS `code`,`datadosen`.`tb_lecturer`.`name` AS `name`,concat(`datadosen`.`tb_class`.`cl_major`,'-',`datadosen`.`tb_class`.`cl_level`,`datadosen`.`tb_class`.`cl_name`) AS `class_name`,`datadosen`.`tb_dpa`.`year` AS `year` from ((`datadosen`.`tb_lecturer` join `datadosen`.`tb_dpa`) join `datadosen`.`tb_class`) where ((`datadosen`.`tb_lecturer`.`code` = `datadosen`.`tb_dpa`.`code`) and (`datadosen`.`tb_class`.`cl_id` = `datadosen`.`tb_dpa`.`cl_id_dpa`) and (`datadosen`.`tb_class`.`cl_level` <> 0)) order by concat(`datadosen`.`tb_class`.`cl_major`,'-',`datadosen`.`tb_class`.`cl_level`,`datadosen`.`tb_class`.`cl_name`) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vu_hour_distribution`  AS  select `datadosen`.`tb_lecturer`.`name` AS `name`,`datadosen`.`tb_subjects`.`subject` AS `subject`,concat(`datadosen`.`tb_class`.`cl_major`,'-',`datadosen`.`tb_class`.`cl_level`,`datadosen`.`tb_class`.`cl_name`) AS `class`,sum(`datadosen`.`tb_class_schedule`.`hour`) AS `total_hour`,`datadosen`.`tb_class_schedule`.`semester` AS `semester`,`datadosen`.`tb_class_schedule`.`year` AS `year` from (((`datadosen`.`tb_lecturer` join `datadosen`.`tb_class_schedule` on((`datadosen`.`tb_lecturer`.`code` = `datadosen`.`tb_class_schedule`.`lc_code`))) join `datadosen`.`tb_class` on((`datadosen`.`tb_class`.`cl_id` = `datadosen`.`tb_class_schedule`.`cl_id`))) join `datadosen`.`tb_subjects` on((`datadosen`.`tb_subjects`.`subject_code` = `datadosen`.`tb_class_schedule`.`subject_code`))) group by `datadosen`.`tb_lecturer`.`name`,`datadosen`.`tb_class_schedule`.`semester` ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vu_lecturer_field`  AS  select `datadosen`.`tb_lecturer`.`code` AS `code`,`datadosen`.`tb_lecturer`.`name` AS `name`,`datadosen`.`tb_lecturer`.`field_of_study` AS `field_of_study` from `datadosen`.`tb_lecturer` ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vu_lecturer_personal`  AS  select `datadosen`.`tb_lecturer`.`code` AS `code`,`datadosen`.`tb_lecturer`.`name` AS `name`,`datadosen`.`tb_lecturer`.`status` AS `status`,`datadosen`.`tb_lecturer`.`NIP` AS `NIP`,`datadosen`.`tb_lecturer`.`NIDN` AS `NIDN` from `datadosen`.`tb_lecturer` order by `datadosen`.`tb_lecturer`.`code` desc ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vu_position_2018`  AS  select `datadosen`.`tb_lecturer`.`name` AS `name`,`datadosen`.`tb_position`.`position` AS `position`,`datadosen`.`tb_position`.`year` AS `year` from (`datadosen`.`tb_lecturer` join `datadosen`.`tb_position`) where ((`datadosen`.`tb_lecturer`.`code` = `datadosen`.`tb_position`.`code`) and (`datadosen`.`tb_position`.`position` <> ' ') and (`datadosen`.`tb_position`.`year` = 2018)) order by `datadosen`.`tb_lecturer`.`name` ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vu_position_2019`  AS  select `datadosen`.`tb_lecturer`.`code` AS `code`,`datadosen`.`tb_lecturer`.`name` AS `name`,`datadosen`.`tb_position`.`position` AS `position`,`datadosen`.`tb_position`.`year` AS `year`,`datadosen`.`tb_position`.`semester` AS `semester` from (`datadosen`.`tb_lecturer` join `datadosen`.`tb_position`) where ((`datadosen`.`tb_lecturer`.`code` = `datadosen`.`tb_position`.`code`) and (`datadosen`.`tb_position`.`position` <> ' ') and (`datadosen`.`tb_position`.`year` = 2019)) order by `datadosen`.`tb_lecturer`.`name` WITH CASCADED CHECK OPTION ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vu_research`  AS  select `datadosen`.`tb_lecturer`.`code` AS `code`,`datadosen`.`tb_lecturer`.`name` AS `name`,`datadosen`.`tb_research_category`.`research` AS `research`,`datadosen`.`tb_researcher`.`priority` AS `priority` from ((`datadosen`.`tb_lecturer` join `datadosen`.`tb_researcher`) join `datadosen`.`tb_research_category`) where ((`datadosen`.`tb_lecturer`.`code` = `datadosen`.`tb_researcher`.`code`) and (`datadosen`.`tb_research_category`.`rs_id` = `datadosen`.`tb_researcher`.`rs_id`) and (`datadosen`.`tb_research_category`.`research` <> 'None')) order by `datadosen`.`tb_researcher`.`priority` WITH CASCADED CHECK OPTION ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vu_research_group_details`  AS  select `datadosen`.`tb_research_category`.`research` AS `research`,`datadosen`.`tb_research_sub_category`.`research_sub_category` AS `research_sub_category` from (`datadosen`.`tb_research_category` join `datadosen`.`tb_research_sub_category` on((`datadosen`.`tb_research_category`.`rs_id` = `datadosen`.`tb_research_sub_category`.`rs_id`))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vu_teachings`  AS  select `datadosen`.`tb_lecturer`.`code` AS `code`,`datadosen`.`tb_lecturer`.`name` AS `name`,`datadosen`.`tb_teaching_rules`.`weekly_teaching_time` AS `weekly_teaching_time`,`datadosen`.`tb_teaching_rules`.`weekly_hour_quota` AS `weekly_hour_quota`,`datadosen`.`tb_teaching_rules`.`distribution_19_20` AS `distribution_19_20`,`datadosen`.`tb_teaching_rules`.`quota_19_20` AS `quota_19_20` from (`datadosen`.`tb_lecturer` join `datadosen`.`tb_teaching_rules`) where (`datadosen`.`tb_lecturer`.`code` = `datadosen`.`tb_teaching_rules`.`code`) order by `datadosen`.`tb_lecturer`.`name` ;
