...
class fieldLec_API extends REST_Controller {
    ...
    public function index_delete(){
        ...
        if($code === null){
            ...
            if ($this->admin_model->deleteLecturerField($code) > 0) {
                echo 'ok';
                $this->response([
                    'status'    => true,
                    'code'        => $code,
    ...
    public function index_post(){
        ...
        if($this->admin_model->createLecturerField($data)){
            $this->response([
                'status' => true,
     ...
     public function index_put(){
        $data = [
            'code' => $this->put('code'),
            'name'  =>$this->put('name'),
            'field'=>$this->put('field'),
        ];

        if($this->admin_model->updateLecturerField($data) > 0){
            $this->response([
                'status' => true,
